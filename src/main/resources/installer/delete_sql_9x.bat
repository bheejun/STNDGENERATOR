...
set "LOG_FILE=%~dp0delete_result.log"
...
:RUN
echo [%date% %time%] WDQ SQL deletion started.
...
echo [ERROR] This deletion supports WDQ 9.0, 9.1, and 9.2 only.
exit /b 11
:VERSION_SUPPORTED
...
echo Deleting generated data from %DATABASE% ...
